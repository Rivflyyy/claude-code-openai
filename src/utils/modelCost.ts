...
// OpenAI GPT-4 pricing: $30 input / $60 output per Mtok (approximate for custom endpoints)
export const COST_OPENAI_GPT4 = {
  inputTokens: 30,
  outputTokens: 60,
...
// OpenAI GPT-4o pricing: $5 input / $15 output per Mtok
export const COST_OPENAI_GPT4O = {
  inputTokens: 5,
  outputTokens: 15,
  promptCacheWriteTokens: 0,
  promptCacheReadTokens: 0,
...
// Generic OpenAI pricing (for custom models like gpt-5.4)
export const COST_OPENAI_GENERIC = {
  inputTokens: 10,
  outputTokens: 30,
  promptCacheWriteTokens: 0,
  promptCacheReadTokens: 0,
...
export const MODEL_COSTS: Record<ModelShortName, ModelCosts> = {
  ...
  [firstPartyNameToCanonical(CLAUDE_OPUS_4_6_CONFIG.firstParty)]:
    COST_TIER_5_25,
  // OpenAI models
  'gpt-4': COST_OPENAI_GPT4,
  'gpt-4-turbo': COST_OPENAI_GPT4,
  'gpt-4o': COST_OPENAI_GPT4O,
  'gpt-4o-mini': COST_OPENAI_GPT4O,
  'gpt-5': COST_OPENAI_GENERIC,
  'gpt-5.4': COST_OPENAI_GENERIC,
}
